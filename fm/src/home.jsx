  ...
  return (
    <div className="flex flex-col justify-start items-center w-full bg-[#141418] text-[#ff1e00] py-12">
      <header className="flex flex-col items-center justify-center mx-auto">
        <p className="text-[3rem] sm:text-[6.2rem] max-w-[800px] mx-auto my-0 text-white text-center px-4 font-weight-black">
          FormulaMetric
        </p>
      </header>
      <DriverPodium />{" "}
      {/*displaying the podium of drivers for the 2025 season*/}
      <section className="text-center mx-[0] my-4 px-4">
        <h2 className="text-[2.15rem] mb-4">What is FormulaMetric?</h2>
        <p className="text-[1.2rem] max-w-[800px] mx-[auto] my-[0]">
          FormulaMetric provides quick and objective analytics for Formula 1
          drivers using a proprietary 4-factor scoring system. Track performance
          trajectories, compare absolute performance, consistency across races,
          and relative performance against teammates. Settle debates with
        ...
        <div className="grid grid-cols-2 gap-6 px-4 md:grid-cols-5 mb-8">
          <div className="bg-[#1e1e1e] border border-[#4F4A4A] rounded-lg p-6 hover:bg-slate-900 transition-colors">
            ...
            <p className="text-sm text-white/70">
              Measures how a driver&apos;s performance improves or declines
          ...
          <div className="bg-[#1e1e1e] border border-[#4F4A4A] rounded-lg p-6 hover:bg-slate-900 transition-colors">
            ...
            <p className="text-sm text-white/70">
              Evaluates the driver&apos;s raw performance compared to their
              peers.
            </p>
          </div>
          <div className="bg-[#1e1e1e] border border-[#4F4A4A] rounded-lg p-6 hover:bg-slate-900 transition-colors">
            ...
            <p className="text-sm text-white/70">
              Assesses how reliably a driver performs across different races.
            </p>
          </div>
          <div className="bg-[#1e1e1e] border border-[#4F4A4A] rounded-lg p-6 hover:bg-slate-900 transition-colors">
            ...
            <p className="text-sm text-white/70">
              Compares the driver&apos;s performance relative to their
              teammates.
            </p>
          </div>
          <div className="bg-[#1e1e1e] border border-[#4F4A4A] rounded-lg p-6 hover:bg-slate-900 transition-colors">
            ...
            <p className="text-sm text-white/70">
              Combines all four factors into one comprehensive performance
              metric.
            </p>
          </div>
        </div>
      </section>
      <div className="w-full flex items-center justify-center mt-8 mx-auto">
        <div className="flex flex-col sm:flex-row gap-4">
          <Link
            to="/drivers"
            className="w-full sm:w-auto inline-block text-center cursor-pointer hover:bg-[#e01b00] bg-[#ff1e00] text-white border-none px-6 sm:px-[1.5em] py-3 sm:py-[0.8em] text-[1rem] sm:text-[1.1rem] transition-colors rounded-[8px]"
          >
            Explore Drivers Comparisons
          </Link>
          <Link
            to="/rankings"
            className="w-full sm:w-auto inline-block text-center cursor-pointer hover:bg-[#e01b00] bg-[#ff1e00] text-white border-none px-6 sm:px-[1.5em] py-3 sm:py-[0.8em] text-[1rem] sm:text-[1.1rem] transition-colors rounded-[8px]"
